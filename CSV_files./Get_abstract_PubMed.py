...
# -*- coding: utf-8 -*-
"""
Created on Thu Dec 29 12:16:39 2022
...
while run and loop_counter<= 180:
...
with open("bloodabstracts.csv", "wt") as abstracts_file:
...
with open("bloodabstracts.csv", "wt") as abstracts_file, open ("partial_bloodabstracts.csv", "wt") as partial_abstracts:
